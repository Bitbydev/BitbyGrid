  ...
  <div class="bit-container">
    ...
    <div class="bit-row">
      <div class="bit-col-50">
        <p>Autocompletar</p>
        <input type="text" class="form-element" id="auto" data-component="auto" data-var="countries">
      </div>
    </div>
    <div class="bit-row">
      <div class="bit-col-50">
        <p>Autocompletar</p>
        <input type="text" class="form-element" id="auto2" data-component="auto" data-var="countries">
      </div>
    </div>
  </div>  
</body>
